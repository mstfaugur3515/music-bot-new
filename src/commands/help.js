...
module.exports = {
    ...
    options: [
        {
            name: "command",
            description: "Belirtilen komutun kullanımını görüntüler.",
            type: 3,
            required: false
        }
    ],
    ...
    execute(client, message, args) {
        ...
        if (!args[0]) {
            ...
            if (!Boolean(found)) return message.reply({ content: '❌ Böyle bir komut bulunamadı.', allowedMentions: { repliedUser: false } });
        }
    },
    ...
    slashExecute(client, interaction) {
        ...
        if (!command) {
            ...
            if (!Boolean(found)) return interaction.reply({ content: '❌ Böyle bir komut bulunamadı.', allowedMentions: { repliedUser: false } });
        }
    },
};
